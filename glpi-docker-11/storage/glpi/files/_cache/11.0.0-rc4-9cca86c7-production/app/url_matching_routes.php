...
return [
    ...
    [ // $dynamicRoutes
        ...
        110 => [[['_route' => 'glpi_form_destination_add', '_controller' => 'Glpi\\Controller\\Form\\Destination\\AddDestinationController'], ['form_id'], ['POST' => 0], null, false, false, null]],
        135 => [[['_route' => 'glpi_form_destination_purge', '_controller' => 'Glpi\\Controller\\Form\\Destination\\PurgeDestinationController'], ['form_id', 'destination_id'], ['POST' => 0], null, false, false, null]],
        149 => [[['_route' => 'glpi_form_destination_update', '_controller' => 'Glpi\\Controller\\Form\\Destination\\UpdateDestinationController'], ['form_id', 'destination_id'], ['POST' => 0], null, false, false, null]],
        171 => [[['_route' => 'glpi_form_render', '_controller' => 'Glpi\\Controller\\Form\\RendererController'], ['id'], ['GET' => 0], null, false, true, null]],
        206 => [[['_route' => 'glpi_add_form_translation', '_controller' => 'Glpi\\Controller\\Form\\Translation\\AddNewFormTranslationController'], ['form_id'], ['POST' => 0], null, false, false, null]],
        232 => [[['_route' => 'glpi_delete_form_translation', '_controller' => 'Glpi\\Controller\\Form\\Translation\\DeleteFormTranslationController'], ['form_id', 'language'], ['POST' => 0], null, false, false, null]],
        240 => [[['_route' => 'glpi_update_form_translation', '_controller' => 'Glpi\\Controller\\Form\\Translation\\UpdateFormTranslationController'], ['form_id', 'language'], ['POST' => 0], null, false, true, null]],
        291 => [[['_route' => 'glpi_delete_helpdesk_translation', '_controller' => 'Glpi\\Controller\\Helpdesk\\Translation\\DeleteHelpdeskTranslationController'], ['language'], ['POST' => 0], null, false, false, null]],
        299 => [[['_route' => 'glpi_update_helpdesk_translation', '_controller' => 'Glpi\\Controller\\Helpdesk\\Translation\\UpdateHelpdeskTranslationController'], ['language'], ['POST' => 0], null, false, true, null]],
        347 => [[['_route' => 'knowbaseitem_content', '_controller' => 'Glpi\\Controller\\Knowbase\\KnowbaseItemController::content'], ['knowbaseitems_id'], null, null, false, false, null]],
        365 => [[['_route' => 'knowbaseitem_full', '_controller' => 'Glpi\\Controller\\Knowbase\\KnowbaseItemController::full'], ['knowbaseitems_id'], null, null, false, false, null]],
        394 => [[['_route' => 'knowbaseitem_search', '_controller' => 'Glpi\\Controller\\Knowbase\\KnowbaseItemController::search'], ['itemtype', 'items_id'], null, null, false, true, null]],
        424 => [[['_route' => 'glpi_plugin_logo', '_controller' => 'Glpi\\Controller\\Plugin\\LogoController'], ['plugin_key'], ['GET' => 0], null, false, false, null]],
        456 => [[['_route' => 'glpi_progress_check', '_controller' => 'Glpi\\Controller\\ProgressController::check'], ['key'], ['GET' => 0], null, false, true, null]],
        511 => [[['_route' => 'glpi_ui_illustration_custom_illustration', '_controller' => 'Glpi\\Controller\\UI\\Illustration\\CustomIllustrationController'], ['id'], ['GET' => 0], null, false, true, null]],
        533 => [
